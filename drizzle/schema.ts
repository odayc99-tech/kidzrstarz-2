...
/**
 * Orders table: tracks each user's transformation request
 * Workflow: user uploads photo → creates order → pays → image generated → ready for download
 */
...
/**
 * Preview images table: stores low-res preview versions for checkout
 */
...
/**
 * Images table: stores metadata about generated images
 */
...
/**
 * Story scenes table: stores individual scenes for the animated storybook
 * Each scene has an illustration, narration audio, and text
 */
